                  ...
                  if (self.pathToOptionsPage) {
                    try {
                      ...
                      if (versionChecker.compare(currentVersion, "78") >= 0) {
                        ...
                        // optionsLabel = "&ColumnsWizard.button.label; &options;";
                        optionsLabel = "ColumnsWizard options";
                      }
                      ...
                      if (!window.document.getElementById(self.menu_addonsManager_prefs_id)) {
                        ...
                        `, ["chrome://messenger/locale/messenger.dtd",
                          "chrome://columnswizard/locale/overlay.dtd", "chrome://messenger/locale/baseMenuOverlay.dtd"]);
